...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'peoples-sdk'
...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')
      expect(isAddress('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')
    })
    it('fails if too long', () => {
      expect(isAddress('77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe('0x77A2...a474')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('77A2FFA74F335931aC852dF094568DB5D3c3a474')).toBe('0x77A2...a474')
    })
